...
# Wait for Wayland display to be available (created by Weston on host)
...
echo "Starting GNOME Session as Wayland client..."

# Start GNOME Session the same way as gnome-wayland.desktop does
# This will run GNOME Shell as a client to the Weston compositor
exec gnome-session
