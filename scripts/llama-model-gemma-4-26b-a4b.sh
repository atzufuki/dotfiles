...
model_id="gemma-4-26b-a4b-it-ud-iq4_xs"
model_name="gemma-4-26B-A4B-it-UD-IQ4_XS.gguf"
model_file="$models_dir/$model_name"
model_url="https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF/resolve/main/$model_name"
